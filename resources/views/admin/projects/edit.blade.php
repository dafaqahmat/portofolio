            ...
            <div class="bento-card overflow-hidden">
                <div class="p-6">
                    <form action="{{ route('admin.projects.update', $project) }}" method="POST" enctype="multipart/form-data" class="space-y-8">
                        ...
                        <div class="space-y-6">
                            <h3 class="text-lg font-medium text-bright border-b border-white/10 pb-2">{{ __('Indonesian') }}</h3>
                            <div>
                            ...
                            <div>
                                ...
                                <textarea id="description_id" name="description_id" rows="4"
                                    class="mt-1 block w-full border-white/10 bg-white/5 text-bright placeholder:text-white/30 focus:border-white/30 focus:ring-white/40 rounded-xl shadow-sm"
                        ...
                        <div class="space-y-6">
                            <h3 class="text-lg font-medium text-bright border-b border-white/10 pb-2">{{ __('English') }}</h3>
                            <div>
                        ...
                        <div class="space-y-6">
                            <h3 class="text-lg font-medium text-bright border-b border-white/10 pb-2">{{ __('Arabic') }}</h3>
                            <div>
                        ...
                        <div class="space-y-6">
                            <h3 class="text-lg font-medium text-bright border-b border-white/10 pb-2">{{ __('Project Details') }}</h3>
                            ...
                            <div>
                                ...
                                <select id="category" name="category"
                                    class="mt-1 block w-full border-white/10 bg-white/5 text-bright focus:border-white/30 focus:ring-white/40 rounded-xl shadow-sm">
                                    <option value="web" class="bg-[#16161A]" {{ old('category', $project->category) === 'web' ? 'selected' : '' }}>Web</option>
                                    <option value="mobile" class="bg-[#16161A]" {{ old('category', $project->category) === 'mobile' ? 'selected' : '' }}>Mobile</option>
                                    <option value="other" class="bg-[#16161A]" {{ old('category', $project->category) === 'other' ? 'selected' : '' }}>Other</option>
                                </select>
                            ...
                            <div>
                                ...
                                <input id="images" name="images[]" type="file" multiple accept="image/*"
                                    class="mt-1 block w-full text-sm text-dim file:mr-4 file:py-2 file:px-4 file:rounded-lg file:border-0 file:text-sm file:font-semibold file:bg-white/10 file:text-bright hover:file:bg-white/20" />
                            ...
                            <div class="flex items-center gap-6">
                                <label class="flex items-center">
                                    <input type="checkbox" name="is_published" value="1"
                                        ...
                                        class="rounded border-white/10 bg-white/5 text-[#333335] shadow-sm focus:ring-white/40">
                                    <span class="ml-2 text-sm text-dim">{{ __('Published') }}</span>
                                </label>
                                <label class="flex items-center">
                                    <input type="checkbox" name="is_featured" value="1"
                                        {{ old('is_featured', $project->is_featured) ? 'checked' : '' }}
                                        class="rounded border-white/10 bg-white/5 text-[#333335] shadow-sm focus:ring-white/40">
                                    <span class="ml-2 text-sm text-dim">{{ __('Featured') }}</span>
                                </label>
                            </div>
                        </div>
                        ...
                        <div class="flex items-center gap-4">
                            ...
                            <a href="{{ route('admin.projects.index') }}"
                                class="inline-flex items-center px-5 py-3 bg-white/5 border border-white/10 rounded-xl font-semibold text-sm text-bright transition-all duration-300 hover:bg-white/10">
                                {{ __('Cancel') }}
                            </a>
                        </div>
                    </form>
