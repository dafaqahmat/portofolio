                        ...
                        <div class="space-y-6">
                            ...
                            <div>
                                ...
                                <select id="category" name="category"
                                    ...
                                    <option value="web" class="bg-[#16161A]" {{ old('category') === 'web' ? 'selected' : '' }}>Web</option>
                                    <option value="mobile" class="bg-[#16161A]" {{ old('category') === 'mobile' ? 'selected' : '' }}>Mobile</option>
                                    <option value="other" class="bg-[#16161A]" {{ old('category') === 'other' ? 'selected' : '' }}>Other</option>
                                </select>
